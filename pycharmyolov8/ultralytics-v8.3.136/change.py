...
# 定义类别顺序
categories = ['battery', 'glass', 'paper']
category_to_index = {category: index for index, category in enumerate(categories)}

# 定义输入文件夹和输出文件夹
input_folder = r'D:\Downloads\Compressed\labelme\data\Annotations'  # 替换为实际的XML文件夹路径
output_folder = r'D:\Downloads\Compressed\labelme\data\labels'  # 替换为实际的输出TXT文件夹路径
