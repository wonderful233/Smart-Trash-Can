...
if __name__ == '__main__':
    file_path = r"D:\Downloads\Compressed\labelme\data\JPEGImages"  # 图片文件夹
    label_path = r'D:\Downloads\Compressed\labelme\data\labels'  # 标签文件夹
    new_file_path = r"D:\Downloads\Compressed\labelme\data\VOCdevkit"  # 新数据存放位置
